...
public class App {
    ...
    */
    static int menu() {
        ...
        // adicione aqui a opção 9, "Exibir histórico de compras de um cliente"
    ...
    static AVL<Integer, Cliente> lerClientes(String nomeArquivoDados) {
    	...
    	// implementar a leitura do arquivo de clientes, seguindo o mesmo padrão usado em lerProdutos:
    ...
    private static void inserirNaTabelaPedidosDoCliente(Cliente cliente, Pedido pedido) {
    	...
    	// implementar, de forma análoga ao método inserirNaTabela(Produto, Pedido):
    ...
    public static void pedidosDoCliente() {
        ...
        System.out.println("Digite o documento do cliente desejado: ");
        int docCliente = teclado.nextInt();
        Cliente escolhido = clientesPorId.pesquisar(docCliente);
        Lista<Pedido> pedidosCliente = pedidosPorCliente.pesquisar(escolhido);
    ...
    public static void main(String[] args) {
        ...
        do{
            ...
            case 9 -> pedidosDoCliente();//adicione aqui o case 9, chamando pedidosDoCliente()
